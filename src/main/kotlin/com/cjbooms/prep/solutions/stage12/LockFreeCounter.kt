...
class LockFreeCounter {
    ...
    fun incrementAndGet(delta: Long = 1): Long {
        // updateAndGet is implemented as a CAS retry loop on the JDK side,
        // so we get the explicit loop semantics for free without sacrificing
        // any of the clarity. Under contention each caller spins on its own
        // register; no OS-level parking, no monitor contention.
