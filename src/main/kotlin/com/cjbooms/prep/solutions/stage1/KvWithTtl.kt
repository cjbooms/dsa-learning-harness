package com.cjbooms.prep.solutions.stage1
...
class KvWithTtl {
    ...
    // key -> (expiryMillis, value)
    private val entries = mutableMapOf<String, Pair<Long, String>>()

    fun put(key: String, value: String, ttlMillis: Long, nowMillis: Long) {
        entries[key] = (nowMillis + ttlMillis) to value
    }

    fun get(key: String, nowMillis: Long): String? {
        val (expiryMillis, value) = entries[key] ?: return null
        return if (nowMillis < expiryMillis) value else null
    }
}
