...
**Estimated time: 75 min** · Package: `stages/stage15`
...
structure-selection ritual first, exactly as in the exercise.
...
- [ ] O(1) amortized — Explain why (each request enters/leaves once)
- [ ] Explain: deque + count vs token bucket — space, burst, precision
...
- [ ] Explain: why the TreeMap beats re-sorting per add
...
- [ ] Explain: pre-order vs BFS trade-offs
