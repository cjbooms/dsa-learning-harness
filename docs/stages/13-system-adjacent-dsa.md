...
**Estimated time: 140 min** · Package: `stages/stage13`
...
ritual is the whole question — the reviewers is listening for the map
...
- [ ] Explain: why LinkedHashMap accessOrder is the shortcut; why CHM alone can't
...
- [ ] Explain: why distributed sharding cares (minimal remapping on node add/remove)
...
- [ ] Explain: how is this different from LRU's single recency list?
