...
**Time budget: 45 min** · Package: `stages/stage0` · Verified target: "concurrent expiring queue" (Glassdoor, Oct 2025)
...
### 0.1 Rebuild from memory (15 min)
